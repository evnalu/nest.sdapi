export class SdapiOptionsDto {
  ...
  jpeg_quality: number = 80.0;
  webp_lossless: boolean = false;
  export_for_4chan: boolean = true;
  img_downscale_threshold: number = 4.0;
  target_side_length: number = 4000.0;
  img_max_size_mp: number = 200.0;
  ...
  notification_volume: number = 100.0;
  ...
  directories_max_prompt_words: number = 8.0;
  ESRGAN_tile: number = 192.0;
  ESRGAN_tile_overlap: number = 8.0;
  ...
  training_image_repeats_per_epoch: number = 1.0;
  training_write_csv_every: number = 500.0;
  ...
  training_tensorboard_flush_every: number = 120.0;
  sd_model_checkpoint: string = "abyssorangemix3AOM3_aom3a1b.safetensors [5493a0ec49]";
  sd_checkpoints_limit: number = 1.0;
  ...
  comma_padding_backtrack: number = 20.0;
  ...
  sdxl_refiner_high_aesthetic_score: number = 6.0;
  ...
  img2img_batch_show_results_limit: number = 32.0;
  cross_attention_optimization: string = "Automatic";
  s_min_uncond: number = 0.0;
  token_merging_ratio: number = 0.0;
  token_merging_ratio_img2img: number = 0.0;
  token_merging_ratio_hr: number = 0.0;
  ...
  interrogate_clip_num_beams: number = 1.0;
  interrogate_clip_min_length: number = 24.0;
  interrogate_clip_max_length: number = 48.0;
  interrogate_clip_dict_limit: number = 1500.0;
  ...
  js_modal_lightbox_gamepad_repeat: number = 250.0;
  ...
  sigma_min: number = 0.0;
  sigma_max: number = 0.0;
  rho: number = 0.0;
  ...
  sd_lora: string = "None";
  lora_preferred_name: string = "Alias from file";
  lora_add_hashes_to_infotext: boolean = true;
  lora_show_all: boolean = false;
  lora_hide_unknown_for_versions: any[] = [];
  lora_in_memory_limit: number = 0;
  lora_functional: boolean = false;
  canvas_hotkey_zoom: string = "Alt";
  canvas_hotkey_adjust: string = "Ctrl";
  canvas_hotkey_move: string = "F";
  canvas_hotkey_fullscreen: string = "S";
  canvas_hotkey_reset: string = "R";
  canvas_hotkey_overlap: string = "O";
  canvas_show_tooltip: boolean = true;
  canvas_auto_expand: boolean = true;
  canvas_blur_prompt: boolean = false;
  canvas_disabled_functions: string[] = [
    "Overlap"
  ];
  settings_in_ui: string = "This page allows you to add some settings to the main interface of txt2img and img2img tabs.";
  extra_options_txt2img: any[] = [];
  extra_options_img2img: any[] = [];
  extra_options_cols: number = 1.0;
